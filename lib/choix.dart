            ...
            child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset('assets/images/pexels-akil-mazumder-1072824.jpg',
                      //fit: BoxFit.cover,
                      /*height: 100,
                      width: 200,*/
                    ),
                  ...
                  Container(
                    height: 80,
                    margin: new EdgeInsets.only(left: 20.0),
                    child: Text('Le Bilan Carbone Personnel ',
                  ...
                  Container(
                    height: 150,
                    margin: new EdgeInsets.only(left: 20.0),
                    child: Text('La consommation d’emprinte carbone prenant en compte '
                        'la production (outils agricoles, d’élevage... ), le transport... ',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.inter(
                        color: dBlack,
                        fontSize: 15,
